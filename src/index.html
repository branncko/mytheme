    ...
    <div class="container">
      <div class="row py-4 align-items-center justify-content-center">
        <div class="col-8 col-md-4 col-lg-3 mb-4 mb-md-0">
          <img src="assets/prot01-02.svg" class="img-fluid" alt="Logotipo IMGfree">
        </div>
        ...
        <div class="card">
          <ul class="list-group list-group-flush">
            <li class="list-group-item border-0">
              ...
              <p class="mb-0">As melhores taxas e condições para voce que deseja realizar todos os seus sonhos na melhor
                fase da vida.</p>
            </li>
      ...
      <div class="col-lg-8 col-12">
        ...
        <div class="row mt-4">
          ...
          <div class="col-md-6 col-sm-12 mt-3 mt-md-0">
            ...
            <p class="mb-0">As melhores taxas e condições para voce que deseja realizar todos os seus sonhos na melhor
              fase da vida.</p>
            <p class="text-muted mt-3"><i class="far fa-clock"></i><small>Publicado em 11 de agosto de 2020</small></p>
          </div>
        </div>
          ...
          <div class="card-body">
            ...
            <form>
              <div class="input-group">
                <input type="text" class="form-control" placeholder="Crédito Pessoal" aria-label="Crédito Pessoal 2"
      ...
      <div class="row">
        <div class="col-md-6 col-sm-12 mb-4">
          <div class="card border-card-footer">
            <div class="card-body">
              <p> <em>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quaerat porro laudantium cumque, harum
                  ratione, aliquid natus consequuntur doloremque error consectetur, dolorem totam amet illum quae odit!
        ...
        <div class="col-md-6 col-sm-12">
          <div class="card border-card-footer">
            <div class="card-body">
              <p><em> Lorem ipsum dolor sit amet, consectetur elit. Nam, provident? Saepe quaerat eos distinctio in
                  odio? Porro deserunt maxime molestiae! Minima amet mollitia praesentium ratione inventore doloribus
