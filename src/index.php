    ...
    <div class="container">
        <div class="row my-5 pt-5">
            <div class="col-lg-4 col-sm-6">
                ...
                <p>As melhores taxas e condições para voce que deseja realizar todos os seus sonhos na melhor fase da
                    vida
                </p>
                ...
                <div class="card">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item border-0">
                            ...
                            <p class="mb-0">As melhores taxas e condições para voce que deseja realizar todos os seus
                                sonhos na melhor
                                fase da vida.</p>
                        </li>
